...
export declare function isDateSelectable(date: NgbDate, minDate: NgbDate, maxDate: NgbDate, isDisabled: boolean, markDisabled?: NgbMarkDisabled): boolean;
export declare function generateSelectBoxMonths(calendar: NgbCalendar, date: NgbDate, minDate: NgbDate, maxDate: NgbDate): number[];
export declare function generateSelectBoxYears(minDate: NgbDate, maxDate: NgbDate): number[];
